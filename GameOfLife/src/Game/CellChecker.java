...
public class CellChecker extends Thread {
    private Field field;
    private int x_up;
    private int y_up;
    private int x_down;
    ...
    public CellChecker(Field field, CyclicBarrier barrier_death, CyclicBarrier barrier_birth, int x_up, int y_up, int x_down, int y_down) {
        this.field = field;
