                    ...
                    if (alive) {
                        switch (color) {
                            case 1:
                                ...
                                break;
                            case 2:
                                setStyle("-fx-background-color: #f60b0b");
                                break;
                            case 3:
                                setStyle("-fx-background-color: #081ad6");
                                break;
                            case 4:
                                setStyle("-fx-background-color: #d4d600");
                                break;
                            case 5:
                                setStyle("-fx-background-color: #d60096");
                                break;
                            case 6:
                                setStyle("-fx-background-color: #d69600");
                                break;
                            case 7:
                                setStyle("-fx-background-color: #00d1d6");
                                break;
                            case 8:
                                setStyle("-fx-background-color: #c6d6bb");
                                break;
                            default:
                                color = 1;
                                setStyle("-fx-background-color: #108029");
