...
public class GamePanel extends JPanel implements MouseMotionListener {
    ...
    private DuckController duckController2;
            ...
            while (!isGameFinished) {
                try {
                    ...
                    while (i < DUCK_NUMBER) {
                        ...
                        duck2 = new Duck();
                        duckController2.setDuck(duck2);
                        duckController2.getDuckAnimation().start();
                        //dogController.getAnimation().start(duckController2.isDead());
                        i++;
                    }
                    if (killedDucks > 5) {
